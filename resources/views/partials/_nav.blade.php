            ...
            <ul class="navbar-nav">      
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item with-badge" href="{{ route('portfolio.gallery')}}">
                                <i class="zmdi zmdi-apps"></i> Portfolio Gallery
                                <span class="badge badge-success text-right">10</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('contact.get') }}" class="nav-link dropdown-toggle animated fadeIn animation-delay-9"  aria-haspopup="true" aria-expanded="false" data-name="contact">Contact
                    </a>
                </li>

                <li class="nav-item dropdown">
                @if (Auth::check())
                    <a href="#" class="nav-link dropdown-toggle animated fadeIn animation-delay-9" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-name="{{ Auth::user()->name }}">Hello, {{ Auth::user()->name }}
                        <i class="zmdi zmdi-chevron-down"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                ...
                @else
                    <a href="#" class="nav-link dropdown-toggle animated fadeIn animation-delay-9" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-name="signin">Hello, Sign In
                        <i class="zmdi zmdi-chevron-down"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{route('login')}}">
                                <i class="zmdi zmdi-arrow-right"></i> Sign In </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{route('register')}}">
                                <i class="zmdi zmdi-account-add"></i> Register Now</a>
                        </li>
