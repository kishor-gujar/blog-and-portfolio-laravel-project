...
<div class="card animated fadeInUp animation-delay-7">
  <div class="ms-hero-bg-info ms-hero-img-mountain">
    ...
    <div class="color-medium index-1 text-center np-m">@kishorgujar95</div>
    <img src="{{ url('storage/'.$post->authorId->avatar) }}" alt="{{$post->authorId->name }}" class="img-avatar-circle"> </div>
